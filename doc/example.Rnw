...
## cache=TRUE tells knitr to build all the plots into a cahce directory
...
source("./r/example.r")
## Need to call up load galaxy function after loading so object 'A' is created
load.galaxy.data()
@
...
%<<appendix-2, child='appendix-1/appendix-1.Rnw'>>=
%@
