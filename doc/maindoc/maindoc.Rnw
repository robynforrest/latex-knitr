...
\fishname\ (\emph{\sciencename}, \commonname) are an important component of the bottom trawl fishery in \bc. They are managed as a coastwide stock, with a TAC of 15,000 t and catch of 10,679 t in 2014. Prior to the introduction of freezer trawlers in the mid-2000s, most of the historical catch of \fishname\ is understood to have been discarded at sea. This was largely due to proteolysis, which occurs in the muscle tissue of this species a short time after it is caught, making the flesh unpalatable. In the past five years, markets have been established for fillets that have been frozen at sea, and the freezer trawl fleet has taken an increasing proportion of the coastwide catch............ Management advice is provided in the form of decision tables which forecast the impacts of a range of 2015 catch levels on \fishname\ stock status relative to these reference points. The Reference Case decision table suggests that a 2015 catch equal to any of the catch levels tested, ranging from 0 t to 30,000 t (twice the 2014 TAC), would result in a 2016 biomass above all of the candidate biomass-based reference points tested, and 2015 harvest rate below the estimated \emph{U}\subscr{MSY}. Large uncertainty in the assessment is however, emphasised. The magnitude of catch and discards prior to 1996 is a major source of uncertainty in this assessment that could provide critical information about the scale and productivity of this stock. Ageing of archived otoliths from the freezer trawl fleet is a high priority recommendation.\\
...
%\fishname\ (\emph{\sciencename}, Family \familyname), also commonly called \commonname, is a species of flatfish that occurs in the offshore waters of \bc. \fishname\ are primarily taken by the groundfish bottom trawl fishery. Here is a citation reference from the bibliography file: \citet{arf2001}.\\
Hello world \citet{arf2001} \\

\subsection{PURPOSE OF DOCUMENT}
To show how knitr and latex work together. See the figures \ref{fig:example-random-stuff}, \ref{fig:example-brownian-motion}, \ref{fig:example-half-torus}, and \ref{fig:example-galaxy}. Here's how you execute simple stats using from R inside latex text block: The mean of x = $\Sexpr{mean(x)}, sd = $\Sexpr{sd(x)} \\
\bigskip

%Appendix \ref{chap:appendix-1}). This assessment identifies reference points for \fishname\ that are consistent with the DFO Decision-making Framework Incorporating the Precautionary Approach (\citet{dfo09}) and characterizes stock status relative to these reference points, using a Bayesian, age-structured stock assessment model. Management advice is provided in the form of decision tables which forecast the impacts of a range of harvest levels on \fishname\ stock status relative to these reference points.\\
